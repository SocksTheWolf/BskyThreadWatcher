/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/wrangler.d.ts` (hash: 977e2305a9276489c917eba3083fa2fc)
...
interface __BaseEnv_Env {
	...
	TARGET: {"values":["at://did:plc:2vueglf2njr5gvdbaf75ih6a/app.bsky.feed.post/3mso2qdbtvl22"]};
	WEBHOOK: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_GALLERY_IMAGES" | "MAX_RECURSE_DEPTH" | "SKIP_DID" | "BSKY_USERNAME" | "USE_QUEUES" | "POST_RECORD_FINDINGS" | "TARGET" | "WEBHOOK" | "BSKY_APP_PASSWORD">> {}
}
